...
func (fake *FakeV3PushVersionActor) GetStreamingLogsForApplicationByNameAndSpace(arg1 string, arg2 string, arg3 v7action.NOAAClient) (<-chan *v7action.LogMessage, <-chan error, v7action.Warnings, error) {
...
func (fake *FakeV3PushVersionActor) GetStreamingLogsForApplicationByNameAndSpaceCalls(stub func(string, string, v7action.NOAAClient) (<-chan *v7action.LogMessage, <-chan error, v7action.Warnings, error)) {
	fake.getStreamingLogsForApplicationByNameAndSpaceMutex.Lock()
...
func (fake *FakeV3PushVersionActor) PollStart(arg1 string, arg2 chan<- v7action.Warnings) error {
...
func (fake *FakeV3PushVersionActor) PollStartCalls(stub func(string, chan<- v7action.Warnings) error) {
	fake.pollStartMutex.Lock()
...
func (fake *FakeV3PushVersionActor) RestartApplication(arg1 string) (v7action.Warnings, error) {
...
func (fake *FakeV3PushVersionActor) RestartApplicationCalls(stub func(string) (v7action.Warnings, error)) {
	fake.restartApplicationMutex.Lock()
