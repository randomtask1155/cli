...
func (fake *FakeOrgActorV3) GetIsolationSegmentsByOrganization(arg1 string) ([]v7action.IsolationSegment, v7action.Warnings, error) {
...
func (fake *FakeOrgActorV3) GetIsolationSegmentsByOrganizationCalls(stub func(string) ([]v7action.IsolationSegment, v7action.Warnings, error)) {
	fake.getIsolationSegmentsByOrganizationMutex.Lock()
